...
class EquivariantGraphTransformer(nn.Module):
    ...
    def __init__(self, input_dims: utils.PlaceHolder, n_layers: int, hidden_mlp_dims: dict, hidden_dims: dict,
                 output_dims: utils.PlaceHolder, is_directed=False, cfg=None):
        super().__init__()
    ...
    def forward(self, data: utils.PlaceHolder):
        ...
        out = utils.PlaceHolder(pos=pos, X=final_X, charges=charges, E=E, y=y, node_mask=node_mask, directed=self.is_directed).mask()
        return out